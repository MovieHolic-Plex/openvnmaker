...
export function ProjectOverview({ script, onNavigate, onSelectScene, onValidate }: Props) {
  const duration = estimateScriptDuration(script);
  ...
  return <section className="project-overview" data-testid="project-overview">
    ...
    <div className="overview-hero">
      <img className="overview-hero-art" src="/assets/art/nocturne-atrium.png" alt="비가 갠 푸른 저녁, 유리 아트리움에 번지는 따뜻한 불빛" />
      ...
      <div className="hero-art-credit"><span>ART COLLECTION / 01</span><b>비가 갠 후의 아트리움</b></div>
    </div>
    ...
    <div className="overview-columns">
      ...
      <button className="overview-art" onClick={() => onNavigate("assets")}><img src="/assets/art/rain-umbrella-cg.png" alt="빗방울과 도시 불빛 사이로 두 손이 닿는 이벤트 CG" /><div><span className="eyebrow">ART DIRECTION</span><h2>장면 너머의 감정까지.</h2><p>배경 · 이벤트 CG · 캐릭터 표정</p><span className="art-open">아트 라이브러리 <Icon name="arrow" size={15} /></span></div></button>
    </div>
